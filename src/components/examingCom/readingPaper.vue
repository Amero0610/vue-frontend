 ...
 * @LastEditors: AmeroL
 * @LastEditTime: 2022-05-09 02:20:29
    ...
    <el-scrollbar style="height: 100%">
      <div id="testbox">
        ...
        <div class="questionBox"
             v-for="(templateItem, index) in questionList"
             :key="index">
          <el-row type="flex"
                  justify=""
                  align="middle">
            <el-col :span="24">
              <el-card>
                <el-row type="flex"
                        justify="start">
                  <el-col :span="1">
                    <p class="questionNo">{{ templateItem.questionNo }}.</p>
                  </el-col>
                  <el-col :span="20">
                    <p class="quesitonContent">{{ templateItem.questionContent }}</p>
                  </el-col>
                </el-row>
                ...
                <el-row class="option"
                        ...
                        align="middle">
                  <el-col :span="1">
                    <el-radio v-model="templateItem.userAns"
                              label="A">A.</el-radio>
                  </el-col>
                  <el-col :span="0"
                          class="optiontext_1">
                  ...
                  <el-col :span="20"
                          :push="1"
                          class="optiontext_2">
                    <span class="optiontext_2">{{ templateItem.AnsA }}</span>
                  </el-col>
                </el-row>
                <el-row class="option"
                        type="flex"
                        v-show="templateItem.AnsB"
                        justify="start"
                        align="middle">
                  <el-col :span="1">
                    <el-radio v-model="templateItem.userAns"
                  ...
                  <el-col :span="21"
                          ...
                          :offset="0"
                          class="optiontext_2">
                    <span class="optiontext_2">{{ templateItem.AnsB }}</span>
                  </el-col>
                </el-row>
                <el-row class="option"
                        type="flex"
                        v-show="templateItem.AnsC"
                        justify="start"
                        align="middle">
                  <el-col :span="1">
                    <el-radio v-model="templateItem.userAns"
                  ...
                  <el-col :span="21"
                          ...
                          :offset="0"
                          class="optiontext_2">
                    <span class="optiontext_2">{{ templateItem.AnsC }}</span>
                  </el-col>
                </el-row>
                <el-row class="option"
                        type="flex"
                        v-show="templateItem.AnsD"
                        justify="start"
                        align="middle">
                  <el-col :span="1">
                    <el-radio v-model="templateItem.userAns"
                  ...
                  <el-col :span="21"
                          ...
                          :offset="0"
                          class="optiontext_2">
                    <span class="optiontext_2">{{ templateItem.AnsD }}</span>
                  </el-col>
                </el-row>
              </el-card>
            </el-col>
